    ...
    <>
      <DashboardUI>
        <header className="flex items-center justify-between">
          <div className="flex items-center justify-between w-full">
            ...
            <div className="flex items-center gap-2 bg-slate-200 p-1 rounded-full transition-all duration-700 ease-linear">
              <div onClick={openUploadPage} className={`flex items-center gap-2 ${isUploadPage ? "bg-blue-500 text-white" : ""} py-2 px-3 rounded-full transition-all duration-700 ease-linear hover:cursor-pointer`}>
                <span>
                  <VideoUploadIcon />
                </span>
                <span>Upload Video</span>
              </div>
              <div onClick={openLivePage} className={`flex items-center gap-2 ${isLivePage ? "bg-blue-500 text-white" : ""} py-2 px-3 rounded-full transition-all duration-700 ease-linear hover:cursor-pointer`}>
                <span>
                  <LiveTeachingIcon />
                </span>
        ...
        <section className="mt-10 flex gap-3 flex-wrap">
          {
            isLivePage ? <LiveContainer /> : isUploadPage ? <UploadContainer /> : null
          }
        </section>
      </DashboardUI>
    </>
